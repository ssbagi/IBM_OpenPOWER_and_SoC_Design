/* Testbench for the synchronous-reset up/down counter. */

`timescale 1ns/1ps

module up_down_counter_synchronous_reset_tb;
    ...
    up_down_counter_synchronous_reset dut (
        .clk(clk),
        .reset(reset),
        .up(up),
        .count(count)
    ...
    initial begin
        $dumpfile("4_bit_up_down_synchronous_reset_tb.vcd");
        $dumpvars(0, up_down_counter_synchronous_reset_tb);
        ...
        $display("====================================================");
        $display(" Synchronous Reset 4-bit Up/Down Counter Test     ");
        $display("====================================================");
        ...
        if (failure_count == 0)
            $display("\nPASS: %0d/%0d synchronous-reset tests passed.",
